from models import UserModel, ProjectModel, ProjectPermissionModel, TokenBlacklistModel
...
def user_have_permission_for_project(username, project_id, min_permission):
